...
import com.ken.cruddemo.entity.*;
...
public class CruddemoApplication {
	...
	private void addMoreCoursesForStudent(AppDAO appDAO) {
		int id = 1;
		Course course1 = new Course("Python Masterclass");
		Course course2 = new Course("Tennis Pro!");
	...
	private void createCourseAndStudents(AppDAO appDAO) {
		...
		Student student2 = new Student("Mary", "Jane", "mary@outlook.com");
		course.add(student1);
		course.add(student2);
		...
		appDAO.save(course);
		System.out.println("Done!"); // cascading persist - save to associated entities
	}
