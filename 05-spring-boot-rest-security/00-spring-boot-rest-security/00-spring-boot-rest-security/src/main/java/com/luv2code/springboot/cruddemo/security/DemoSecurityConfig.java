...
public class DemoSecurityConfig {
        ...
        public UserDetailsManager userDetailsManager(DataSource dataSource) {
            ...
            theUserDetailsManager.setUsersByUsernameQuery("SELECT user_id, pw, active FROM members WHERE user_id=?"); // how to find users
            theUserDetailsManager.setAuthoritiesByUsernameQuery("SELECT user_id, role FROM roles WHERE user_id=?"); // how to find roles
